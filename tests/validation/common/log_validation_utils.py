                ...
                for keyword in error_keywords:
                    if keyword.lower() in line.lower():
                        ...
                        if "ERROR" in keyword and ("NO ERROR" in line.upper() or "NO_ERROR" in line.upper()):
                            continue
                        errors.append({"line": line.strip(), "line_number": i + 1, "keyword": keyword})
                        break
...
def validate_log_file(
    log_file_path: str, required_phrases: List[str], direction: str = "", error_keywords: Optional[List[str]] = None
) -> Dict:
    """
...
def output_validator(log_file_path: str, error_keywords: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    return {"is_pass": is_pass, "errors": errors, "phrase_mismatches": []}  # Not used in this simple validator
