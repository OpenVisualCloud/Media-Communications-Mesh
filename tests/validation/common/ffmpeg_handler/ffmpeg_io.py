...
class FFmpegIO:
    def __init__(
        self,
        read_at_native_rate: bool = False,
        stream_loop: int | None = None,
        input_path: str | None = None,
        output_path: str | None = None,
        segment: int | bool = False,
        **kwargs,
    ):
...
class FFmpegVideoIO(FFmpegIO):
    def __init__(
        ...
        f: str | None = FFmpegVideoFormat.raw.value,
...
class FFmpegAudioIO(FFmpegIO):
    def __init__(
        self,
        ar: int | None = FFmpegAudioRate.k48.value,
        f: str | None = FFmpegAudioFormat.pcm24.value,
        ac: int | None = 2,
        **kwargs,
    ):
        super().__init__(**kwargs)
