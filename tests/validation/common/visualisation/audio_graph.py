...
def read_pcm(
    ...
    with open(file_path, "rb") as f:
        if pcm_format == 8:
            ...
            pcm_data = (
                np.left_shift(pcm_data[:, 0].astype(np.int32), 16)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Output file name for the waveform plot.",
    )
    parser.add_argument(
        "--num_channels1",
        type=int,
        default=2,
        help="Number of channels in the first PCM file.",
    )
    parser.add_argument(
        "--num_channels2",
        type=int,
        default=2,
        help="Number of channels in the second PCM file.",
    )
    parser.add_argument(
        "--downsample_factor",
        type=int,
    ...
    parser.add_argument(
        ...
        choices=[8, 16, 24],
        default=16,
        help="PCM format (8, 16, or 24 bits).",
    )
