...
The following arguments are supported to configure a connection to Media Communications Mesh:
...
The following arguments are supported to configure a video transmission:
