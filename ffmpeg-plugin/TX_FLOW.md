...
Diagrams in this document show interaction between FFmpeg and the MCM plugin when FFmpeg is sending a video file over MCM.
...
sequenceDiagram
   ...
   mux ->> mux: Write data into buffer
   mux ->> sdk: Send buffer
